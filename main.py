...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    major_login.client_version = "1.123.17"
    major_login.system_software = "Android OS 12 / API-31 (RKQ1.211119.001/Q.202510131819)"
    major_login.system_hardware = "Handheld"
    major_login.telecom_operator = "Jio True5G"
    major_login.network_type = "CarrierDataNetwork"
    major_login.screen_width = 1666
    major_login.screen_height = 750
    major_login.screen_dpi = "450"
    major_login.processor_details = "ARM64 FP ASIMD AES | 4800 | 8"
    major_login.memory = 7395
    major_login.gpu_renderer = "Adreno (TM) 620"
    major_login.gpu_version = "OpenGL ES 3.2 V@0502.0 (GIT@1159e70389, I1027f1d7d9, 1649418316) (Date:04/08/22)"
    major_login.unique_device_id = "Google|8be34d81-1222-4db0-bbfe-8b55dc20387d"
    major_login.client_ip = "152.58.158.67"
    ...
    major_login.network_operator_a = "Jio True5G"
    major_login.network_type_a = "5G"
    major_login.client_using_version = "1ac4b80ecf0478a44203bf8fac6120f5"
    major_login.external_storage_total = 103182
    major_login.external_storage_available = 29595
    major_login.internal_storage_total = 583
    major_login.game_disk_storage_available = 29723
    major_login.game_disk_storage_total = 103182
    major_login.external_sdcard_avail_storage = 29723
    major_login.external_sdcard_total_storage = 103182
    major_login.login_by = 1
    major_login.library_path = "/data/app/~~nDitxM4AX3jbEaeVo7ccgQ==/com.dts.freefiremax-4qMaTDdwJ-f8p5GrpPGQjg==/lib/arm64"
    major_login.reg_avatar = 2
    major_login.library_token = "6f165e0dad93a8933dacd1d54724e273|/data/app/~~nDitxM4AX3jbEaeVo7ccgQ==/com.dts.freefiremax-4qMaTDdwJ-f8p5GrpPGQjg==/base.apk"
    major_login.channel_type = 2
    major_login.cpu_type = 2
    major_login.cpu_architecture = "64"
    major_login.client_version_code = "2019117601"
    major_login.graphics_api = "OpenGLES3"
    major_login.supported_astc_bitset = 255
    major_login.login_open_id_type = 4
    major_login.loading_time = 11123
    major_login.release_channel = "android_max"
    major_login.extra_info = "KqsHTxDMbEeIpiwDLAAUy6Hu3lq1Pjxsb0DBKsEh7Y/DyQUExCQPIbZCaq6bI4XYInF5hczO4mvF5LNUEJenXMWf7OY="
...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('16043794479')  # <-- FIXED BOT UID

    Uid, Pw = '5182118472', 'F52CAF9BC59A6C140803BFC3BD9C500B6638F0D2EF77FBCDC6913538E43E8739'
